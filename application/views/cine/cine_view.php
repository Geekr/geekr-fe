                    ...
                    <div class="span5 thumb">
                        <div class="view view-first">
                            ...
                            <div class="mask">
                                ...
                                <a href="cine/ver_post/<?=$row->slug?>" class="link"></a>
                            </div>
                        </div>
                    </div>                    
                    <div class="span6 descripcion" style="padding:35px 10px 15px 25px;display:inline-block;">
                        <h4><a href="cine/ver_post/<?=$row->slug?>"><?=$row->mid_title?></a></h4>
...
<?php $this->load->view('layout/footer'); ?>
       ...
       <!-- <div style="clear:both;float:left;"class="paginado"><?=$this->pagination->create_links();?></div>-->